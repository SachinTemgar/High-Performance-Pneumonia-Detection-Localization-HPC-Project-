...
Note:
This notebook was executed on a High-Performance Computing (HPC) cluster (Open OnDemand environment).
...
🧩 Parallelization significantly reduced training time (≈2× faster),
though efficiency dropped beyond 4 CPUs due to synchronization overhead — consistent with Amdahl’s Law.
