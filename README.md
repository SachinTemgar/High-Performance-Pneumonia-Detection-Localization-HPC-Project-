...
Performance graphs and bounding-box visualizations include:

Training time vs. number of processes (2–8 CPUs)

Accuracy and loss curves

YOLOv8 bounding boxes on test images (pneumonia localization)
